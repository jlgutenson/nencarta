...
setup(
    name='nencarta',  # Replace with a unique name for your package
    version='0.1.1',
    description='A library for estimaing riverine bathymetry and performing flood inundation mapping.',
    long_description=open('README.md').read(),
    long_description_content_type='text/markdown',
    author='Joseph Gutenson',
    author_email='joseph@follumhydro.com',
    url='https://github.com/yourusername/flood-mapping-library',  # Update with your repo URL
